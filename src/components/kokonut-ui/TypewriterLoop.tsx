...
export default function TypewriterLoop({
    ...
    return (
        <div className="relative w-full max-w-4xl h-[20px] mx-auto">
            <div
                className="relative text-center z-10 flex flex-col items-center justify-center"
                ref={scope}
            >
                <motion.div
                    className="text-sm md:text-md tracking-tight flex items-center gap-2"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                >
                    <span
                        data-typewriter
                        className="inline-block border-r-1 text-white/30 text-shadow-sm border-white/30 animate-cursor pr-1"
                    >
                        {sequences[0].text}
                    </span>
                </motion.div>
